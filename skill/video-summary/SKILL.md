---
name: video-summary
description: Summarize tutorial, commentary, strategy, lecture, and long-form spoken videos by extracting audio, transcribing locally with Whisper, then organizing the result into concise notes, pocket cards, or structured summaries. Use when the user sends a Bilibili link, YouTube link, local audio file, local video file, or asks to summarize spoken video content from links/files.
---
